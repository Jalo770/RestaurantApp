...
/**
 * LogIn Page display a LogIn and also provides the
 * access through Firebase Authentication.
 */
...
public class LogIn extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSignInButton = (SignInButton) findViewById(R.id.activity_log_in_signInButton);
        ...
        mGoogleApiClient = new GoogleApiClient.Builder(getApplicationContext())
                .enableAutoManage(this, new GoogleApiClient.OnConnectionFailedListener() {
                    ...
                    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
                        ...
                        Toast.makeText(LogIn.this, "Error has occured", Toast.LENGTH_LONG).show();
                    }
                })
